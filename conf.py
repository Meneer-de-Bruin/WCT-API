...
htmlhelp_basename = 'wct-api'
html_theme = 'sphinx_rtd_theme'
file_insertion_enabled = False
latex_documents = [
  ('index', 'wct-api.tex', u'WCT-API Documentation',
   u'', 'manual'),
]
...
context = {
    ...
    'downloads': [ 
    ("pdf", "//wct-api.readthedocs.io/_/downloads/en/latest/pdf/"),
    ("html", "//wct-api.readthedocs.io/_/downloads/en/latest/htmlzip/"),
    ("epub", "//wct-api.readthedocs.io/_/downloads/en/latest/epub/"),
    ],
    'subprojects': [ 
    ],
    'slug': 'wct-api',
...
if 'branch' == 'external':
    ...
    readthedocs_build_url = 'https://readthedocs.org/projects/wct-api/builds/21399034/'
